...
<body>
    ...
    <a href="cartPage.html">
        ...
        <div class="container">
            <h1 class="lg-title">Boy's clothes</h1>
            ...
            <div class="product-items">
                ...
                <div class="product">
                    <div class="product-content">
                        <div class="product-img">
                            <img src="images/tsh1.jpg" alt="product image">
                        </div>
                    ...
                    <div class="product-info">
                        ...
                        <a href="#" class="product-name">Boy's clothes, new product</a>
                ...
                <div class="product">
                    <div class="product-content">
                        <div class="product-img">
                            <img src="images/tsh2.jpg" alt="product image">
                        </div>
                        <div class="product-btns">
                            <button type="button" class="btn-cart"> add to cart
                                <span><i class="fas fa-plus"></i></span>
                ...
                <div class="product">
                    <div class="product-content">
                        <div class="product-img">
                            <img src="images/tsh3.jpg" alt="product image">
                        </div>
                        <div class="product-btns">
                            <button type="button" class="btn-cart"> add to cart
                                <span><i class="fas fa-plus"></i></span>
